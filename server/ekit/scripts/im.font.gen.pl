#!/usr/bin/perl -w
# $Id: im.font.gen.pl,v 1.3 2011-08-29 23:54:15 triton Exp $
# Script adapted from Anthony Thyssen (see below)
# It's under Triton CVS just for fun
#
# THIS SCRIPT SHOULD BE RUN AS ROOT WITH A COMMAND LIKE THIS:
#
#     perl im.font.gen.pl >/usr/share/ImageMagick-6.5.7/config/font.xml
#
# OR ALTERNATIVELY IT CAN BE RUN AS TRITON, AND THE BUILT FONT DICTIONARYFILE CAN LIVE FOR THE TRITON USER AS...
#
#     perl im.font.gen.pl >~/.magick/type.xml
#
...
sub Usage {
  die @_, &herefile( qq{
    ...
    |     </typemap>
    |
    | Note that later definitions will override earlier ones. As such "myfonts"
